...
_Static_assert(BOARD_KEYA_PORT == GPIOB, "KEYA port changed");
_Static_assert(BOARD_KEYA_PIN == GPIO_PIN_8, "KEYA pin must be PB8");
_Static_assert(BOARD_KEYB_PORT == GPIOB, "KEYB port changed");
_Static_assert(BOARD_KEYB_PIN == GPIO_PIN_9, "KEYB pin must be PB9");
